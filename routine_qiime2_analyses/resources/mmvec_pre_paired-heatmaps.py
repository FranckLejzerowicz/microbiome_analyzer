...
omic1_common_fp_tmp_qza = Artifact.import_data("FeatureTable[Frequency]", omic1_common_fp_tmp_biom)
...
omic2_common_fp_tmp_qza = Artifact.import_data("FeatureTable[Frequency]",
                                               omic2_common_fp_tmp_biom)
...
taxonomy_tsv_pd = taxonomy_tsv_pd.rename(columns={taxonomy_tsv_pd.columns[0]: 'Feature ID'})
...
omic2_common_fp_tmp_qza = Artifact.import_data(
    "FeatureData[Conditional]", omic2_common_fp_tmp_pd)
